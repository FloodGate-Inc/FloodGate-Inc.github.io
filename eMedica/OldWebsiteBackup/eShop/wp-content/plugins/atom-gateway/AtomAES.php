...
class AtomAES {
    ...
    public function secure_carddata_encrypt($data){
        $method = "DES-ECB";    
        $encrypted = openssl_encrypt($data, $method, '61220121', OPENSSL_RAW_DATA);
        return base64_encode($encrypted);
    }

    public function secure_carddata_decrypt($data){
        $method = "DES-ECB";    
        $decrypted = openssl_decrypt(base64_decode($data), $method, '61220121', OPENSSL_RAW_DATA);
        return $decrypted;
    }
